...
class MetaData(Base):
    ...
    __table_args__ = (
            # UniqueConstraint('name_id', 'rdtype', 'rdata', name='answer_nameid_rdtype_rdata_cnt_u'),
    ...
    def __repr__(self):
        return (f"<MetaData: id={self.id!r}, date_added={self.date_added!r}, file_name={self.file_name!r}, "
                ...
                f"sections={self.sections!r}, entropy={self.entropy!r}, certificates={self.certificates!r}>")
